            ...
            <div className="bg-white rounded-2xl p-5 shadow-lg shadow-gray-200/50 border border-gray-100 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                        ...
                        <div className="font-bold text-gray-900 text-sm mb-1">{selectedPackage?.name}</div>
                        <p className="text-xs text-gray-500 mb-2 line-clamp-1">{selectedPackage?.description}</p>
                        <div className="text-xs font-bold text-gray-600 flex items-center gap-1">
                            <Clock size={10} /> {selectedPackage?.duration} mins
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                        ...
                        <div className="text-blue-600 text-sm font-bold flex items-center gap-1.5 mt-1">
                            <Clock size={14} />
                            {selectedTime ? formatTime(selectedTime) : 'No time'}
                        </div>
                    </div>
                </div>

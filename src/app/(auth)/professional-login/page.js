...
import { ArrowRight, Mail, Lock, Eye, EyeOff, Camera, Loader2, CheckCircle2, XCircle } from 'lucide-react'
...
export default function ProfessionalLoginPage () {
  ...
  const handleSubmit = async e => {
    ...
    setIsLoading(true)
    try {
      const result = await login(formData, 'professional')
        ...
        <div className='w-full max-w-md'>
          ...
          >
            ...
            <button
              ...
              className='w-full px-8 py-4 border-2 border-gray-200 rounded-2xl font-semibold text-gray-700 hover:bg-gray-50 transition-all flex items-center justify-center gap-3'
            >
        ...
        <div className='relative z-10 h-full flex flex-col justify-center px-16'>
          ...
          >
            ...
            <p className='text-gray-300 text-xl leading-relaxed mb-12'>
              Manage your portfolio, connect with premium clients, and grow your
              photography business on the world's leading creative platform.
            </p>
            ...
            <div className='grid grid-cols-3 gap-8'>
              <div>
                ...
                <div className='text-sm text-gray-400'>Earned by Pros</div>
              </div>
              <div>
